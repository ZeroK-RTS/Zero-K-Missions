unitDef = {
  ...
  customParams        = {
    ...
    helptext       = [[The Athena is the pinnacle of stealth strike capability. Equipped with a cloaking device and a radar jammer, it can slip through enemy lines to assemble squads of raiders, inflicting havoc on the opposition's logistics. This version was custom-built for Lilith, sacrificing the resurrection module for more armor and resource generation.]],

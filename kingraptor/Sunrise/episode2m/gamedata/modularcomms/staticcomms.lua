local comms = {
  comm_mission_tutorial1 = {
	...
	description = "Relic Commander, Builds at 15 m/s",
  ...
  comm_riot = {
    ...
    modules = { "commweapon_riotcannon", "weaponmod_plasma_containment", "module_ablative_armor", "module_ablative_armor", "module_autorepair", "module_high_power_servos" },
  },
  comm_recon = {
    chassis = "commrecon2",
	name = "Ghost Recon",

...
local carrierDefNames = {
	armcarry = {
		spawnPieces = {"base"},
		{drone = UnitDefNames.carrydrone.id, reloadTime = 15, maxDrones = 8, spawnSize = 2, range = 1600, buildTime=3, maxBuild=1,
	...
	reef = {
		...
		{drone = UnitDefNames.carrydrone.id, reloadTime = 3, maxDrones = 8, spawnSize = 1, range = 1600, buildTime=15, maxBuild=4,
	...
	funnelweb = {
		...
		{drone = UnitDefNames.attackdrone.id, reloadTime = 10, maxDrones = 6, spawnSize = 2, range = 800, buildTime=3, maxBuild=1,
		 offsets = {0,35,0,colvolMidX=0, colvolMidY=0,colvolMidZ=0,aimX=0,aimY=0,aimZ=0}},
		{drone = UnitDefNames.battledrone.id, reloadTime = 15, maxDrones = 2, spawnSize = 1, range = 800, buildTime=3, maxBuild=1,
		 offsets = {0,35,0,colvolMidX=0, colvolMidY=0,colvolMidZ=0,aimX=0,aimY=0,aimZ=0}},
	},
	nebula = {
		spawnPieces = {"pad1", "pad2", "pad3", "pad4"},
		{drone = UnitDefNames.fighterdrone.id, reloadTime = 12, maxDrones = 10, spawnSize = 2, range = 1000, buildTime=3, maxBuild=1,
		 offsets = {0,8,15,colvolMidX=0, colvolMidY=30,colvolMidZ=0,aimX=0,aimY=0,aimZ=0}}, --shift colvol to avoid collision.
		--{drone = UnitDefNames.attackdrone.id, reloadTime = 12, maxDrones = 6, spawnSize = 2, range = 800, buildTime=3, maxBuild=1,
		-- offsets = {0,8,15,colvolMidX=0, colvolMidY=30,colvolMidZ=0,aimX=0,aimY=0,aimZ=0}},
		--{drone = UnitDefNames.battledrone.id, reloadTime = 15, maxDrones = 2, spawnSize = 1, range = 800, buildTime=3, maxBuild=1,
		-- offsets = {0,8,15,colvolMidX=0, colvolMidY=30,colvolMidZ=0,aimX=0,aimY=0,aimZ=0}},
	},
}
...
local presets = {
	module_companion_drone = {drone = UnitDefNames.attackdrone.id, reloadTime = 10, maxDrones = 2, spawnSize = 1, range = 450, buildTime=3, maxBuild=1,
							 offsets = {0,35,0,colvolMidX=0, colvolMidY=0,colvolMidZ=0,aimX=0,aimY=0,aimZ=0}},
	module_battle_drone = {drone = UnitDefNames.battledrone.id, reloadTime = 20, maxDrones = 1, spawnSize = 1, range = 600, buildTime=3, maxBuild=1,
							offsets = {0,35,0,colvolMidX=0, colvolMidY=0,colvolMidZ=0,aimX=0,aimY=0,aimZ=0}},
}

...
local CloudDefs = {
  speed = 0.4, -- multiplier for speed of scrolling with wind
  color    = {0.8, 0.8, 0.85}, -- diffuse color of the fog
  ...
  fade_alt = 200; -- fog will linearly fade away between this and "height", should be between height and bottom
  scale = 800, -- how large will the clouds be
  opacity = 0.9, -- what it says

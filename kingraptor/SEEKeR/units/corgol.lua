unitDef = {
  ...
  customParams        = {
	...
	description_pl = [[Bardzo ciezki niszczyciel czolgow]],
	...
	helptext_pl    = [[Goliath to najciezszy czolg na polu bitwy. Jego glowne dzialo zadaje ciezkie obrazenia pojedynczym celom i wyrownuje teren, a jego drugorzedny promien spowalniajacy nie pozwala przeciwnikom od niego uciec. Goliath ma maly zasieg i trudnosci z manewrowaniem, jednak pod wzgledem wytrzymalosci i sily ognia to jedna z najpotezniejszych jednostek.]],
	extradrawrange = 350,
  },
